...
All I want (I want) for Christmas (all I really want) is you, baby `
    ...
    {trackId:"music/song2.mp3", title:"	Santa Tell Me – Ariana Grande",
            lyrics:`Santa Tell Me
...
'Cause I can't give it all away if he won't be here next year`
    ...
    {trackId:"music/song3.mp3", title:"Winter Things – Ariana Grande",
         lyrics:`Winter Things
...
My baby's in town and we're gonna do some winter things, hey, yeah`
    ...
    {trackId:"music/song4.mp3", title:"	Snowman – Sia",
         lyrics:`Snowman
...
Baby`
    ...
    {trackId:"music/song5.mp3", title:"Santa’s Coming for Us – Sia",
         lyrics:`Santa’s Coming for Us
...
(Oh, da da da, oh, da da da)
(Oh, da da da, oh, da da da)`},
    {trackId:"music/song6.mp3", title:"Underneath the Tree – Kelly Clarkson",
...
Underneath, underneath the tree`
    ...
    {trackId:"music/song7.mp3", title:"Mistletoe – Justin Bieber",
         lyrics:`Mistletoe
...
Show me, baby, that you love me so-oh-oh, oh, oh, oh (oh, whoa, oh whoa)`
    ...
    {trackId:"music/song8.mp3", title:"Christmas Tree Farm – Taylor Swift",
         lyrics:`Christmas Tree Farm
...
I love you`
    ...
    {trackId:"music/song9.mp3", title:"	Cozy Little Christmas – Katy Perry",
         lyrics:`Cozy Little Christmas
...
A cozy little Christmas here with you`
    ...
    {trackId:"music/song10.mp3", title:"Night Before Christmas – Sam Smith",
         lyrics:`Night Before Christmas
...
And have a Merry Christmas everyone, everywhere`
    ...
    {
        trackId:"music/song11.mp3",title:"I'll Be Home For Christmas-camila cabella",lyrics:`
...
{
    trackId:"music/song12.mp3",title:"Jingle Bell Rock-Bobby Helms",lyrics:`
...
{
    trackId:"music/song13.mp3",title:"Make it To Christmas - A lessia cara",lyrics:`
...
{
    trackId:"music/song14.mp3",title:"Like It's Christmas-Jonas_Brothers",lyrics:`
    Like It's Christmas
Da-dom-dom-dom-dom
...
And I don't wanna miss a single thing
Don't wanna put end to all this cheer
But as long as you're with me, it's always the time of the year, yeah
...
Right up at the top (I can't deny)
I can't deny what I'm feelin' inside
Nothin' fake about the way you bring me to life
You make every day feel like it's Christmas
Every day that I'm with you
...
{
    trackId:"music/song15.mp3",title:"It’s a beginning to look a lot like Christmas ",lyrics:`
...
{
    trackId:"music/song16.mp3",title:"Last_Christmas I give you my heart-wham",lyrics:`
    Last_Christmas I give you my heart
...
{
    trackId:"music/song17.mp3",title:"Justin Bieber-Christmas Love",lyrics:`
    Christmas Love
    Baby, I will not pout, baby, I will not cry
'Cause I got your love this Christmas time
When the snow's on the ground and it's freezin' outside
...
Tell Santa I'm cool this year, my present is standin' right here
...
{
    trackId:"music/song18.mp3",title:"Back to December - Taylor Swift",lyrics:`
    Back to December
...
{
    trackId:"music/song19.mp3",title:"Christmas Without You - Ava Max",lyrics:`
...
{
    trackId:"music/song20.mp3",title:"Christmas tree - V ",lyrics:`
    Christmas tree
...
{
    trackId:"music/song21.mp3",title:"First Snow - Exo",lyrics:`
    First snow
    첫눈 오는 이런 오후에 너에게
전화를 걸 수만 있다면 기쁠텐데
벌써 일년이 지났는데 난 아직 미련
...
{
    trackId:"music/song22.mp3",title:"Snow Flower - V",lyrics:`
     Snow Flower 
    Hey snow
It's coming today
뭘 준비하면 돼
...
웃는 네 미소에 꽃이 내려지길 yeah eh
    ...
    trackId:"music/song23.mp3",title:"The Best Thing I ever Did- Twics",lyrics:`
...
혼자 있어도 내 뒤에 네가 있는 것처럼 느껴 자꾸 귀가
빨개지는 걸 어떡해? 계속 널 생각해
늘 외롭기만 했었던, 쓸쓸했었던
12월이 이젠 외롭지 않아, ooh
내가 올해 제일 잘한 일
...
내가 올해 안한 일 중에 제일 잘한 일
너와 헤어지지 않은 것, 함께 있는 것
올해를 little by little, 보내면서 수많은 일을
의미를 떠올려봐도 왜 모두
너와 함께한 순간들뿐인지? 나 왠지
사랑에 빠졌나 봐
내가 올해 제일 잘한 일
너를 만난 것 (ooh), 너를 만난 것 (oh, whoa), 너를 만난 것
내가 올해 안한 일 (oh) 중에 제일 잘한 일 (잘한 일)
너와 헤어지지 않은 것, 함께 있는 것 (함께 있는 것)
All I wanna do, all I wanna do (oh)
이대로, 이대로, 이대로, 이대로 너와 영원히 둘이
(너와 영원히 둘이) all I wanna do, all I wanna do
이대로, 이대로, 이대로, 이대로 변하지 않고 우리
...
{
    trackId:"music/song24.mp3",title:"Christmas Evel - StrayKids",lyrics:`
    Christmas Evel
...
{
    trackId:"music/song25.mp3",title:"Merry Happy - Twice",lyrics:`
    Merry Happy
    매년 12월 달력을 넘길 때마다
시작되는 그 알 수 없는 허전함은
모른 척을 해봐도 밀려올 때마다
...
function renderPlaylist(songs) {
    ...
    songs.forEach((song, index) => {
        ...
        songItem.innerHTML = `
            <img src="${shuffledImages[index % shuffledImages.length]}" alt="Christmas" class="song-image">
...
const secularBtn = document.getElementById('secularBtn');
const gospelBtn = document.getElementById('gospelBtn');

secularBtn.addEventListener('click', () => {
    secularBtn.classList.add('active', 'secular');
    gospelBtn.classList.remove('active', 'gospel');
    renderPlaylist(secularSongs);
});

gospelBtn.addEventListener('click', () => {
    gospelBtn.classList.add('active', 'gospel');
    secularBtn.classList.remove('active', 'secular');
    renderPlaylist(gospelSongs);
});
